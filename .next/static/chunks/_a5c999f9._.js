(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_a5c999f9._.js", {

"[project]/src/app/event/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EventPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EventPage.useEffect": ()=>{
            if (eventName) {
                fetch(`http://localhost:5000/api/get-event-details/${eventName}`).then({
                    "EventPage.useEffect": (res)=>res.json()
                }["EventPage.useEffect"]).then({
                    "EventPage.useEffect": (data)=>setEventDetails(data)
                }["EventPage.useEffect"]);
            }
        }
    }["EventPage.useEffect"], [
...
_s(EventPage, "CK1bZ8npYf2u1qfjWZbm/IF1Kmk=", false, function() {
    return [
...
//# sourceMappingURL=_a5c999f9._.js.map